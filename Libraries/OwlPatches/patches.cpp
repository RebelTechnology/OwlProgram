...
// REGISTER_PATCH(FastFourierTestPatch, "Robotization", 2, 2);
...
REGISTER_PATCH(FeedbackCombFilterPatch, "Feedback Comb Filter", 2, 2);
...
REGISTER_PATCH(FeedbackCombFilter, "FeedbackCombFilter", 1, 1);
TO BE WORKED ON
*/
